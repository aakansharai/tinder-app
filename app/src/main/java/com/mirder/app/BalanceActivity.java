...
public class BalanceActivity extends ActivityBase {
    ...
    static final String ITEM_SKU_1 = "dating.raccoonsquare.com.iap1";            // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = "dating.raccoonsquare.com.iap2";            // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = "dating.raccoonsquare.com.iap3";            // Change to: yourdomain.com.iap3
