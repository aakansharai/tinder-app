...
import com.mirder.app.BuildConfig;
import com.mirder.app.R;
...
import com.mirder.app.model.Settings;
import com.mirder.app.util.CustomRequest;
import com.mirder.app.util.LruBitmapCache;
    ...
    public Boolean authorize(JSONObject authObj) {
        ...
        try {
            ...
            if (accountArray.length() > 0) {
                ...
                this.setAllowVideoCalls(accountObj.getInt("allowVideoCalls"));
