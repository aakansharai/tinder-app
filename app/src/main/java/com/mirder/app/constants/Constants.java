package com.mirder.app.constants;
...
public interface Constants {
    ...
    String WEB_SITE = "https://mirder.mimeld.com/";  //web site url address
    ...
    String BILLING_KEY = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA06dhoysip7K1";
    ...
    String API_DOMAIN = "https://mirder.mimeld.com/";  // url address to which the application sends requests | with back slash "/" at the end | example: https://mysite.com/ | for emulator on localhost: http://10.0.2.2/
    ...
    public static final int AGORA_CALL_STATUS_UNKNOWN = -1;
    public static final int AGORA_CALL_STATUS_OUTGOING = 0;
    public static final int AGORA_CALL_STATUS_INCOMING = 1;
    public static final int AGORA_CALL_STATUS_ENDED = 2;
    public static final int AGORA_CALL_STATUS_CANCELED = 3;
    public static final int AGORA_CALL_STATUS_ACTIVE = 4;
