...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int allowVideoCalls, allowShowMyInfo, allowShowMyGallery, allowShowMyFriends, allowShowMyLikes, allowShowMyGifts, allowShowMyAge, allowShowMySexOrientation, allowShowOnline;
