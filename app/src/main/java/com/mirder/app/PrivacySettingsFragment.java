...
public class PrivacySettingsFragment extends PreferenceFragmentCompat implements Constants {
    ...
    private CheckBoxPreference mAllowVideoCalls, mAllowInfo, mAllowGallery, mAllowFriends, mAllowLikes, mAllowGifts;

    private ProgressDialog pDialog;

    int allowVideoCalls, allowLikes, allowFriends, allowInfo, allowGifts, allowGallery;
